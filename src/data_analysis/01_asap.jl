...
# ╔═╡ b62fd14d-576f-4252-a18f-95928db5b41c
using DataFrames;

# ╔═╡ d0989964-5036-49df-848e-fe8865374846
using CSV;

# ╔═╡ 112d2d5a-df83-4c5e-b113-5f808b14730a
using Plots;

# ╔═╡ 5082e301-6d9f-4eca-9175-348df70caa22
using StatsPlots;

# ╔═╡ 9caadc55-fa5f-4ab2-b368-239f941ef93e
using Interact

# ╔═╡ c9d8cb12-9a21-4946-a5f2-1b3667db69fe
using Blink

# ╔═╡ c0545c91-5d8c-4288-9406-ada3cc7a8d84
df = DataFrame(CSV.File("../../data/original/Cu-NLP/CU-NLP.csv"))

# ╔═╡ a34155bf-b7fc-47e0-9a71-2b66c5cfc3aa
...
manifest_format = "2.0"
project_hash = "fa6685ec4a710d494a5cd9f1f59ef78f445078ce"
